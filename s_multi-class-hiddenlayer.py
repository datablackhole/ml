...
# Step 1 Convolution
classifier.add(Convolution2D(128,(3,3), input_shape = (64,64,3),padding='same')) # 32 no of 3x3 filters(feauture detectors)
...
# Step 2 hidden layer
classifier.add(Convolution2D(128,(3,3),padding='same')) # 32 no of 3x3 filters(feauture detectors)
classifier.add(Activation('relu'))
classifier.add(Convolution2D(32, (3, 3)))
classifier.add(Activation('relu'))
classifier.add(Dropout(0.25))
